...
{
	csize=nf*pow(4,depth);
	c1 = (int*)malloc(csize*sizeof(int));
	c2 = (int*)malloc(csize*sizeof(int));
	c3 = (int*)malloc(csize*sizeof(int));
...
void drawIcos(GLfloat v1[3], GLfloat v2[3], GLfloat v3[3])
{
  ...
  // draw trinagles
  glColor3ub( c1[indx]%256, c2[indx]%256, c3[indx]%256 );
